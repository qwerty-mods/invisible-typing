...
export const Icon = () => (
  <components.Tooltip text="Enable/Disable Typing">
    <components.Clickable
      style={{ marginTop: 5 }}
      onClick={() => {
        cfg.set("invisible", !cfg.get("invisible", true));
        const stroke = document.getElementsByClassName("disabled-stroke-through")[0];
        stroke.classList.toggle("invistype-disabled"); // it's a memo, forceupdate don't work
      }}>
